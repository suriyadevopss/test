...
const lambda =new lambdaStack(app, 'prodlambdastack', props);

const sns = new snsstack(app, 'prodsnsstack', props);

const passwordpolicy = new PasswordPolicyStack (app, 'prodPasswordPolicyStack', props);
