...
const lambda =new lambdaStack(app, 'devlambdastack', props);

const sns = new snsstack(app, 'devsnsstack', props);

const passwordpolicy = new PasswordPolicyStack (app, 'devPasswordPolicyStack', props);
